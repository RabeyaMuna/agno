...
class Agent:
    ...
    events_to_skip: list[RunEvent] | None = None
    ...
    def _convert_response_to_structured_format(self, run_response: RunResponse | ModelResponse):
        # Convert the response to the structured format if needed
    ...
    def _handle_model_response_chunk(
        ...
        model_response_event: ModelResponse | RunResponseEvent | TeamRunResponseEvent,
    ...
    def get_messages_for_parser_model_stream(
        self, run_response: RunResponse, response_format: dict | type[BaseModel] | None
    ) -> list[Message]:
        """Get the messages for the parser model."""
        system_content = (
            self.parser_model_prompt
    ...
    def _deep_copy_field(self, field_name: str, field_value: Any) -> Any:
        ...
        elif field_name in ("memory", "storage", "model", "reasoning_model") or isinstance(
            field_value, (list, dict, set)
        ):
            try:
        ...
        **kwargs: Any,
        ...
        if stream:
            ...
            with Live(console=console) as live_log:
                ...
                for resp in self.run(
                    ...
                    **kwargs,
                    ...
                    response_content: str | JSON | Markdown | None = (
            ...
            with Live(console=console) as live_log:
                ...
                response_content_batch: str | JSON | Markdown = ""  # type: ignore
